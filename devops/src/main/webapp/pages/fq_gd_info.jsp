    ...
    <form id="form1" method="post">
        ...
        <table cellpadding="1" cellspacing="7" style="width:100%;">
            <tr>
                ...
                <td style="width: 85px"> <label>处理部门:</label></td>
                <td >    
                        <input style="width:165px" name="dept_id" class="mini-combobox" valueField="id" textField="name" 
                            url=""
                            onvaluechanged="onDeptChanged" required="true"
            ...
            <tr>
                <td style="width: 85px"> <label>关联工单:</label></td>
                <td >    
                    <input style="width:165px" name="name" class="mini-textbox" required="true"/>
                </td>
                 <td style="width: 85px"> <label>关联类型:</label></td>
                <td >    
                        <input style="width:165px" name="dept_id" class="mini-combobox" valueField="id" textField="name" 
                            url=""
                            onvaluechanged="onDeptChanged" required="true"
                ...
                <td style="width: 85px"> <label>是否属实:</label></td>
                <td >    
                        <input style="width:165px" name="dept_id" class="mini-combobox" valueField="id" textField="name" 
                            url=""
                            onvaluechanged="onDeptChanged" required="true"
            ...
            <tr>
               <td style="width: 85px"> <label>是否办结:</label></td>
                <td >    
                        <input style="width:165px" name="dept_id" class="mini-combobox" valueField="id" textField="name" 
                            url=""
                            onvaluechanged="onDeptChanged" required="true"
                    ...
                    <td style="width: 85px"> <label>是否电力公司责任:</label></td>
                <td >    
                        <input style="width:165px" name="dept_id" class="mini-combobox" valueField="id" textField="name" 
                            url=""
                            onvaluechanged="onDeptChanged" required="true"
             ...
             <tr>
                <td style="width: 85px"><label>处理情况:</label></td>
                <td colspan="5">    
                    <input style="width:98%" name="remarks" class="mini-textarea"  />
                </td>
            </tr>         
        ...
        <table cellpadding="1" cellspacing="7" style="width:100%;">
            <tr>
                <td style="width: 85px"> <label>审核结果:</label></td>
                <td >    
                        <input style="width:165px" name="dept_id" class="mini-combobox" valueField="id" textField="name" 
                            url=""
                            onvaluechanged="onDeptChanged" required="true"
                ...
                <td style="width: 85px"> <label>审核时间:</label></td>
                <td >    
                    <input style="width:165px" name="birthday" class="mini-datepicker" required="true" emptyText="请选择日期"/>
                </td>
            </tr>
            <tr>
                <td style="width: 85px"><label>审核意见:</label></td>
                <td colspan="5">    
                    <input style="width:98%" name="remarks" class="mini-textarea"  />
                </td>
            </tr>          
        ...
        <table cellpadding="1" cellspacing="7" style="width:100%;">
            <tr>
                <td style="width: 85px"> <label>确认结果:</label></td>
                <td >    
                        <input style="width:165px" name="dept_id" class="mini-combobox" valueField="id" textField="name" 
                            url=""
                            onvaluechanged="onDeptChanged" required="true"
