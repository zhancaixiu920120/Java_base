...
<body>    
    <form id="form1" method="post">
        ...
        <div style="text-align:center;padding:10px;">               
            <a class="mini-button" onclick="onOk" style="width:60px;margin-right:20px;">派单</a>       
            <a class="mini-button" onclick="onCancel" style="width:60px;margin-right:20px;">回退</a>       
            <a class="mini-button" onclick="onOk" style="width:65px;margin-right:20px;">直接办结</a>       
